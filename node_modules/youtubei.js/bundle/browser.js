...
var Playlist = class extends YTNode {
  constructor(data2) {
    ...
    if (Reflect.has(data2, "thumbnailRenderer")) {
      this.thumbnail_renderer = parser_default.parseItem(data2.thumbnailRenderer, PlaylistVideoThumbnail_default) || void 0;
    }
...
var StructuredDescriptionContent = class extends YTNode {
  constructor(data2) {
    super();
    this.items = parser_default.parseArray(data2.items, [VideoDescriptionHeader_default, ExpandableVideoDescriptionBody_default, VideoDescriptionMusicSection_default, VideoDescriptionInfocardsSection_default]);
  }
};
...
var EngagementPanelSectionList = class extends YTNode {
  constructor(data2) {
    ...
    this.content = parser_default.parseItem(data2.content, [SectionList_default, ContinuationItem_default, StructuredDescriptionContent_default]);
      ...
      case "misc":
        switch (inference_type.misc_type) {
          ...
          case "Author": {
            ...
            return author_should_optional ? new Author(__classPrivateFieldGet(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, inference_type.params[0]]), inference_type.params[1] ? __classPrivateFieldGet(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data: data2 }, [...key_path, inference_type.params[1]]) : void 0) : void 0;
          }
        }
        throw new Error("Unreachable code reached! Switch missing case!");
      case "primative":
