...
var Playlist = class extends YTNode {
  constructor(data) {
    ...
    if (Reflect.has(data, "thumbnailRenderer")) {
      this.thumbnail_renderer = parser_default.parseItem(data.thumbnailRenderer, PlaylistVideoThumbnail_default) || void 0;
    }
...
var StructuredDescriptionContent = class extends YTNode {
  constructor(data) {
    super();
    this.items = parser_default.parseArray(data.items, [VideoDescriptionHeader_default, ExpandableVideoDescriptionBody_default, VideoDescriptionMusicSection_default, VideoDescriptionInfocardsSection_default]);
  }
};
...
var EngagementPanelSectionList = class extends YTNode {
  constructor(data) {
    ...
    this.content = parser_default.parseItem(data.content, [SectionList_default, ContinuationItem_default, StructuredDescriptionContent_default]);
      ...
      case "misc":
        switch (inference_type.misc_type) {
          ...
          case "Author": {
            ...
            return author_should_optional ? new Author((0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[0]]), inference_type.params[1] ? (0, import_tslib8.__classPrivateFieldGet)(this, _a, "m", _YTNodeGenerator_accessDataFromKeyPath).call(this, { data }, [...key_path, inference_type.params[1]]) : void 0) : void 0;
          }
        }
        throw new Error("Unreachable code reached! Switch missing case!");
      case "primative":
...
var FormatUtils = class {
        ...
        pull: (controller) => (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
          ...
          return new Promise((resolve, reject) => (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
              ...
              try {
                for (var _e = true, _f = (0, import_tslib31.__asyncValues)(streamToIterable(body)), _g; _g = yield _f.next(), _b2 = _g.done, !_b2; ) {
                  _d = _g.value;
                  _e = false;
                  try {
                    const chunk = _d;
  ...
  static toDash(streaming_data, url_transformer = (url) => url, format_filter, cpn, player, actions) {
    return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
      ...
      yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateAdaptationSet).call(this, document, period, adaptive_formats, url_transformer, cpn, player, actions);
...
_a3 = FormatUtils, _FormatUtils_el = /* @__PURE__ */ __name(function _FormatUtils_el2(document, tag, attrs, children = []) {
      ...
      if (mime_objects[i][0].has_audio && mime_objects[i][0].audio_track) {
        ...
        for (let j = 0; j < track_ids.length; j++) {
          ...
          for (const format of track_objects[j]) {
            yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, cpn, player, actions);
          }
        }
      } else {
        const set = (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "AdaptationSet", {
        ...
        for (const format of mime_objects[i]) {
          if (format.has_video) {
            yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateRepresentationVideo).call(this, document, set, format, url_transformer, cpn, player, actions);
          } else {
            yield (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_generateRepresentationAudio).call(this, document, set, format, url_transformer, cpn, player, actions);
          }
        }
  ...
  return (0, import_tslib31.__awaiter)(this, void 0, void 0, function* () {
    ...
    const representation = (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "Representation", {
      ...
      (0, import_tslib31.__classPrivateFieldGet)(this, _a3, "m", _FormatUtils_el).call(this, document, "AudioChannelConfiguration", {
...
var MediaInfo = class {
  ...
  toDash(url_transformer, format_filter) {
    return (0, import_tslib32.__awaiter)(this, void 0, void 0, function* () {
      return FormatUtils_default.toDash(this.streaming_data, url_transformer, format_filter, (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"), (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib32.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"));
    });
  }
...
var VideoInfo = class extends MediaInfo {
  constructor(data, actions, cpn) {
    ...
    if (results && secondary_results) {
      ...
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_3 = this.watch_next_feed.at(-1)) === null || _3 === void 0 ? void 0 : _3.is(ContinuationItem_default)))
        (0, import_tslib33.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, (_4 = this.watch_next_feed.pop()) === null || _4 === void 0 ? void 0 : _4.as(ContinuationItem_default), "f");
...
var Kids = class {
  ...
  search(query) {
    return (0, import_tslib54.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Search_default2((0, import_tslib54.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  getInfo(video_id) {
    var _a7;
...
var Music = class {
  ...
  search(query, filters = {}) {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Search2(response, (0, import_tslib55.__classPrivateFieldGet)(this, _Music_actions, "f"), Reflect.has(filters, "type") && filters.type !== "all");
    });
  }
  getHomeFeed() {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
...
var Innertube = class {
  ...
  get music() {
    return new Music((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get studio() {
    return new Studio((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get kids() {
    return new Kids((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get account() {
    return new AccountManager((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get playlist() {
    return new PlaylistManager((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get interact() {
    return new InteractionManager((0, import_tslib60.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get actions() {
